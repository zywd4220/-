...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/meituan-logo.png" alt="美团商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="" value="${userInfo.nickname }"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="${user.phone }"/>
		<input type="hidden" name="orderShipping.receiverState" value="${userShipping.receiverProvince}"/>
		<input type="hidden" name="orderShipping.receiverCity" value="${userShipping.receiverCity }"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="${userShipping.receiverArea }"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="${userShipping.receiverAddress }"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">${userInfo.nickname }</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">电话：${user.phone }</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">${userShipping.receiverProvince}&nbsp&nbsp&nbsp ${userShipping.receiverCity } &nbsp&nbsp&nbsp ${userShipping.receiverArea }</div>
						<div class="adr-m" limit="30">${userShipping.receiverAddress }</div>
			...
			<ul id="payment-list">
				...
				<li style="cursor: pointer;" onclick="save_Pay(1);">
					<div class="payment-item item-selected online-payment "
						...
						<b></b> 支付宝<span class="qmark-icon qmark-tip"
				...
				<li style="cursor: pointer;" onclick="save_Pay(4);">
					...
					<div class="payment-item  online-payment "
						...
						<b></b> 微信 <font class="whiteBarSpanClass hide"
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：美团商城</h4>		         
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">美团配送<i
						class='qmark-icon qmark-tip'
						data-tips='由美团公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由美团配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
