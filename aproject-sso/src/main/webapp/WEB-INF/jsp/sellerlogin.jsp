...
<div class="w">
    <div id="logo">
    	<a href="http://localhost:8082" clstag="passport|keycount|login|01">
    		<img src="/images/meituan-logo.png" alt="美团" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 300px; height: 300px; position: absolute; left: 0px; top: 0px; background: url(/images/logo.jpg) 0px 0px no-repeat;">
			</div>
            <div class="form ">
        ...
        <div class="free-regist">
            <span><a href="/page/sellerregister" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<script type="text/javascript">
	...
	var LOGIN = {
			...
			doLogin:function() {
				$.post("/seller/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						if (redirectUrl == "") {
